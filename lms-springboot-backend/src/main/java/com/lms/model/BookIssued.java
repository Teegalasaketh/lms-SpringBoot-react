...
public class BookIssued {
	...
	public BookIssued(int issueId,int studentIssueNo, String isbn, String bookName, int regId, String name, Date reserveDate,
			Date issueDate, Date renewalDate,Date dueDate, Date returnedDate, String status) {
		super();
		this.issueId = issueId;
		this.studentIssueNo = studentIssueNo;
		this.isbn = isbn;
	...
	public int getStudentIssueNo() {
	    return studentIssueNo;
	}

	public void setStudentIssueNo(int studentIssueNo) {
	    this.studentIssueNo = studentIssueNo;
	}
